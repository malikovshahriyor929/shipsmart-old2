...
const widgetCardClasses = {
  base: "border border-muted bg-gray-0 p-5 dark:bg-gray-50 lg:p-7 dark:border-gray-200",
  rounded: {
    sm: "rounded-sm",
    DEFAULT: "rounded-lg",
    lg: "rounded-xl",
    ...
    >
      ...
      >
        <div>
          <Title
            as="h3"
            className={cn("text-base font-semibold sm:text-lg text-mainBlue", titleClassName)}
          >
            {title}
          </Title>
          {description && (
