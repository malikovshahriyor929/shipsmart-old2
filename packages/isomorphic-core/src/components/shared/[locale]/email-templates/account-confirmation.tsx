...
export default function VercelInviteUserEmail(
  userEmail: string = 'advisor@routex.uz',
  username: string = 'Mr. Advisor',
  demoLink: string = 'https://shipsmart.example.com'
) {
  const previewText = `Join ${username} in ShipSmart!`;
      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Heading style={heading}>
            Welcome to <strong>ShipSmart</strong>
          </Heading>
          ...
          <Text style={subheading}>
            You have been invited to join the ShipSmart platform. Click the
