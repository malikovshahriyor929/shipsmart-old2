      ...
      <div className="flex h-full flex-col p-5">
        <div className="-mx-5 mb-6 flex items-center justify-between border-b border-muted px-5 pb-4">
          ...
          <ActionIcon
            ...
            rounded="full"
            variant="text"
            title={t("commons.close-filter") ?? "Close Filter"}
...
export default function TableFilter({
  ...
  setCheckedColumns,
  hideIndex,
  drawerTitle = t("commons.table-filters") ?? "Table Filters",
  hasSearched,
    ...
    <div className="table-filter mb-4 flex items-center justify-between">
      <div className="flex flex-wrap items-center gap-4">
        {!showSearchOnTheRight ? (
          <Input
            type="search"
            placeholder={t("commons.search-by-anything") ?? "Search by anything..."}
            value={searchTerm}
        ...
        {children ? (
          ...
          >
            ...
            {!(isMediumScreen || enableDrawerFilter) && showFilters
              ? t("commons.hide-filters") ?? "Hide Filters"
