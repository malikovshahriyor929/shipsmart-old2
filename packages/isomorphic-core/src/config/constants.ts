...
export const PLACEHOLDER_THUMB = "/PLACEHOLDER_COURSES_THUMB.png";
export const PLACEHOLDER_GLOBAL = "/PLACEHOLDER_IMAGE.png";
export const PLACEHOLDER_AVATAR = "/avatar.webp";
